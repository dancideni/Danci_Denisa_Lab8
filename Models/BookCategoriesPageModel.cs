...
namespace Danci_Denisa_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Danci_Denisa_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Danci_Denisa_Lab8Context context,
